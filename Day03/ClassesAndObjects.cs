        ...
        private static void updateCustomer()
        {
            ...
            foreach (var cst in _customers)
            {
                if (cst != null && cst.CustomerName.Contains(nameToFind))
                {
                    ...
                    var address = MyConsole.GetString("Update Billing Address");
                    var id = MyConsole.GetNumber("Update the ID");
                    var date = MyConsole.GetDate("Update date of Billing");
                    var amount = MyConsole.GetDouble("Update Billing amount");
                }
            }
